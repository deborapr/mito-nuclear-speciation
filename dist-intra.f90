! program dist-intra.f90

! computes the nuclear and mitochondrial genetic similarities within each species
...
stname = trim(path)//'mito_dist_intra.dat'
...
stname = trim(path)//'nuclear_dist_intra.dat'
OPEN(unit=15,file=stname)
!dist = 0
ii = 0
DO i1=1,igt
